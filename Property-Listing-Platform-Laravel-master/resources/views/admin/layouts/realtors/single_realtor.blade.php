...
<!-- ============================================================== -->
            ...
            <div class="container-fluid" style="background: #036161;">
                ...
                <!-- ============================================================== -->
                <!-- Row -->
                <h2 class="page-title text-light text-center" style="margin-left: -35%; margin-bottom: 20px;">Realtor Profile</h2>
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_number" class="form-control" value="{{ $realtor -> contact_number }}">
