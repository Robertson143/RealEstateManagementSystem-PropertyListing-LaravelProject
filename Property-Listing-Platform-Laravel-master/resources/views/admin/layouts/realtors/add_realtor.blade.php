...
<!-- ============================================================== -->
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
              <!--  <h4 class="page-title text-center text-light"  style="background: #036161;">Add Realtor</h4>-->
            </div>
    ...
    <h2 class="page-title text-light text-center" style="margin-left: -5%; margin-bottom: 20px;">Add Realtor</h2>
        <!-- ============================================================== -->
        <!-- Start Page Content -->
        <!-- ============================================================== -->
        <div class="row">
