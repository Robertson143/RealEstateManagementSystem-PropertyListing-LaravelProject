    ...
    <div class="page-breadcrumb" style="background: #036161;">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title text-light"> User Profile</h4>
            </div>
        ...
        <div class="row" >
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5" >
                <div class="card">
                    ...
                    <div class="card-body"> <small class="text-muted">Phone Number: </small>
                        <h6>911</h6>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('users.update', $user -> id) }}" method="POST" class="form-horizontal m-t-30">
                          ...
                          <!--  <div class="form-group">
                            ...
                            <div class="form-group">
    <label for="role_{{ $user->id }}" class="col-sm-2 control-label">Role:</label>
    <div class="col-sm-10">
