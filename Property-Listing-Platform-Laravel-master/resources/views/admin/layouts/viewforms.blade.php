...
<div class="card" style="margin-top: -20px;">
    <div class="card-header text-center text-light">
        <h2 style="  margin-top: 90px; background: #036161;">Client Application Form</h2> 
    </div>
    ...
    <div class="card-body" style="background: #036161;">
        <div class="row" >
            <div class="col-md-6 mb-3" style="color: white;">
                ...
                <input style="background: #03a614; color: white;" type="text" value="{{ $category->name }}" class="form-control" name="name">
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Unit Name:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->slug }}" class="form-control" name="slug">
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Address</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->description }}" class="form-control" name="description"> 
</div>

<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Email:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->meta_title }}" class="form-control" name="meta_title"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Phone Number:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->meta_keywords }}" class="form-control" name="meta_keywords">
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Birthday:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->birthday }}" class="form-control" name="birthday"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Phase</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->phase }}" class="form-control" name="phase"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Street</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->street }}" class="form-control" name="street"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Block:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->block }}" class="form-control" name="block"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Unit Number:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->unitnumber }}" class="form-control" name="unitnumber"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Monthly Payment:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->income }}" class="form-control" name="income"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Downpayment:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->meta_descrip }}" class="form-control" name="meta_description"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
    <label for="">Reservation Fee:</label>
    <input style="background: #03a614; color: white;" type="text" value="{{ $category->unit }}" class="form-control" name="unit"> 
</div>
<div class="col-md-6 mb-3" style="color: white;">
...
<h3 style="margin-left: 35%; margin-top: 15px; background: white; color: green; margin-bottom: 15px;">&nbsp Client Requirements &nbsp</h3>
<div class="col-md-6 mb-3" style="margin-top: 20px; color: white;">
...
<button type="submit" class="btn btn-success" style="margin-left: 5px;">Update</button>
</form>
