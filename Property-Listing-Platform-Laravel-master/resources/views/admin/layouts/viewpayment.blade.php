...
<div class="card" style="margin-top: -20px;">
    <div class="card-header">
        <h2 style=" text-align: center; margin-bottom: 40px; margin-top: 50px; background: #036161; color: white;">Client Payment Details</h2>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" value="{{ $payment->name }}" class="form-control bg-success" name="name" readonly id="Balance" style="color: white;">
</div>
<div class="col-md-6 mb-3">
    <label for="">Address:</label>
    <input type="text" value="{{ $payment->address }}" class="form-control bg-success" name="address" readonly id="Balance" style="color: white;">
</div>

<div class="col-md-6 mb-3">
    <label for="">Unit Name:</label>
    <input type="text" value="{{ $payment->unit }}" class="form-control bg-success" name="unit" readonly id="Balance" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Unit Price:</label>
    <input type="text" value="{{ $payment->price }}" class="form-control bg-success" name="price" readonly id="Balance" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Phase:</label>
    <input type="text" value="{{ $payment->phase }}" class="form-control bg-success" name="phase" readonly id="Phase" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Street:</label>
    <input type="text" value="{{ $payment->street }}" class="form-control bg-success" name="street" readonly id="Balance" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Block:</label>
    <input type="text" value="{{ $payment->block }}" class="form-control bg-success" name="block" readonly id="Balance" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Unit Number:</label>
    <input type="text" value="{{ $payment->unitnumber }}" class="form-control bg-success" name="unitnumber" readonly id="UnitNumber" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Bank Connected:</label>
    <input type="text" value="{{ $payment->bank }}"class="form-control bg-success" name="bank" readonly id="Balance" style="color: white;">
</div>

<div class="col-md-6 mb-3">
    <label for="">DownPayment:</label>
    <input type="text"  value="{{ $payment->downpayment }}" class="form-control bg-success" name="downpayment" readonly id="Balance" style="color: white;"> 
</div>

<div class="col-md-6 mb-3">
    <label for="">Reservation Fee:</label>
    <input type="text" value="{{ $payment->reservation }}" class="form-control bg-success" name="reservation" readonly id="Balance" style="color: white;" > 
</div>
<div class="col-md-6 mb-3">
    <label for="">Balance:</label>
    <input type="text" value="{{ $payment->balance }}" class="form-control bg-success" name="balance" readonly id="Balance" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Monthly Payment:</label>
    <input type="text" value="{{ $payment->monthly }}" class="form-control bg-success" name="monthly" readonly id="Balance" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Total Payment:</label>
    <input type="text" value="{{ $payment->tax }}" class="form-control" name="tax">
...
<div class="col-md-6 mb-3">
    ...
    <input type="text" value="{{ $payment->contract }}" class="form-control bg-success" name="contract" readonly id="Balance" style="color: white;"> 
</div>
<div class="col-md-6 mb-3">
    <label for="">Months Available:</label>
    <input type="number" value="{{ $payment->total }}" class="form-control" name="total"> 
</div>
...
<h3 style="margin-left: 35%; margin-top: 15px; background: #036161; color: white; margin-bottom: 15px;">&nbsp Submitted Requirements &nbsp</h3>
<div class="col-md-6 mb-3" style="margin-top: 20px;">
...
<button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 170px; margin-left: 82%; margin-top: -1332px; margin-bottom: 115%;">
  Equity Computation
</button>
<!-- Modal -->
