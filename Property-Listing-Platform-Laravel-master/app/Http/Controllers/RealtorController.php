...
class RealtorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($isSuccess){
            return redirect(route('realtors.index'))->with('status', 'Realtor Added Successfully!');
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        $successMessage = redirect(route('realtors.index'))->with('status', 'Realtor Updated Successfully!');
